      ...
      <HStack justify="space-between" w="full">
        <VStack gap="0" align="start">
          ...
          <HStack>
            ...
            <Paragraph size="compact">({formatMoney(item.basePriceMoney.amount)} each)</Paragraph>
          </HStack>
          ...
          {item.totalTaxMoney.amount > 0 && (
            <Paragraph size="compact">Tax: {formatMoney(item.totalTaxMoney.amount)}</Paragraph>
          )}
